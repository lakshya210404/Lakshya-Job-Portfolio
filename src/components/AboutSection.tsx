            ...
            <div className="glass-card rounded-2xl p-8 md:p-12 border-glow">
              <div className="prose prose-invert max-w-none">
                <p className="text-lg text-foreground/90 leading-relaxed mb-6">
                  Hey there! I'm <span className="text-primary font-semibold">Lakshya Prasad</span>, a Computer Science
                  student at the University of Western Ontario with a burning passion for building things that matter. I
                  thrive at the intersection of <span className="text-secondary font-semibold">cloud architecture</span>
                  , <span className="text-primary font-semibold">full-stack development</span>, and{" "}
                  <span className="text-neon-green font-semibold">DevOps engineering</span>.
                </p>
                <p className="text-lg text-foreground/90 leading-relaxed mb-6">
                  With <span className="text-primary font-semibold">4+ internships</span> under my belt at companies
                  like Leavoda Tech, A-Zone Gaming, PCHS, and Sai Dham Food Bank, I've had the privilege of working on
                  enterprise-scale applications, AI-powered platforms, and production-grade microservices. I don't just
                  write code, I architect solutions that scale, perform, and make a real impact.
                </p>
                <p className="text-lg text-foreground/90 leading-relaxed">
                  When I'm not pushing commits, you'll find me exploring the latest in{" "}
                  <span className="text-secondary font-semibold">AI/ML</span>, contributing to open source, or diving
                  deep into system design. I believe in writing clean, maintainable code and constantly pushing the
        ...
        <AnimatedSection delay={300} animation="fade-up">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto mb-16">
            {skills.map((skill) => (
              <div
                key={skill.name}
                className="text-center p-4 rounded-xl glass hover:bg-primary/5 transition-all duration-300 group"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 max-w-4xl mx-auto">
            {[
              ...
              <div key={stat.label} className="text-center">
                ...
                <div className="text-muted-foreground text-sm font-mono uppercase tracking-wider">{stat.label}</div>
              </div>
            ))}
          </div>
        </AnimatedSection>
